function Loca = latitude(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as column vectors.
%   T2M = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   T2M = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   T2m = latitude('data_Athens.csv',1, 2);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/04/24 13:02:34
...
formatSpec = '%*s%f%*s%*s%*s%*s%*s%*s%*s%*s%*s%[^\n\r]';
