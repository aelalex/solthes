...
try
    ...
    Weather_data.latitude = (str2double(tokens{1,1}{1,5})+str2double(tokens{1,1}{1,6})./60)*(2.*strcmpi(tokens{1,1}{1,4},'N')-1);
    Weather_data.longitude = (str2double(tokens{1,1}{1,8})+str2double(tokens{1,1}{1,9})./60)*(2.*strcmpi(tokens{1,1}{1,7},'E')-1);
    Weather_data.elevation = str2double(tokens{1,1}{1,10});
catch exception
    % Handle the error
    ...
    Weather_data.latitude = (str2double(tokens{1,1}{1,6})+str2double(tokens{1,1}{1,7})./60)*(2.*strcmpi(tokens{1,1}{1,5},'N')-1);
    Weather_data.longitude = (str2double(tokens{1,1}{1,9})+str2double(tokens{1,1}{1,10})./60)*(2.*strcmpi(tokens{1,1}{1,8},'E')-1);
    Weather_data.elevation = str2double(tokens{1,1}{1,10});
end
